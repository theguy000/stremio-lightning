...
pub const LINUX_FLATPAK_RUNTIME: &str = "org.freedesktop.Platform";
pub const LINUX_FLATPAK_SDK: &str = "org.freedesktop.Sdk";
pub const LINUX_FLATPAK_RUNTIME_VERSION: &str = "25.08";
